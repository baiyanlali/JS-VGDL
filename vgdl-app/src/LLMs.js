...
const WAGRGCR = `Please create a VGDL representation for a maze game. Please create a game level as well.
...
The VGDL use # as comment, like python. Please do not use # in the vgdl and level file.
`
